<?php
/**
 * Template Name: Admissions Home v2
 */
?>
	...
	<div class="fourcolumn">
        ...
        <div class="col3">
            <div style="margin-left:-232px; margin-top:-45px">
                <a href="https://app.applyyourself.com/AYApplicantLogin/fl_ApplicantConnectLogin.asp?id=berea"><img src="http://www.berea.edu/admissions/wp-content/blogs.dir/16/files/2013/12/ApplyTodayButtonV2.jpg"></a>
            </div>
        </div>
	    <div class="col4">
	        <div id="nav-postit">
	        <a href="/admissions/guidance-counselors/"><div id="counselors-button"></div></a>
	        <a href="/admissions/erin-connor/"><div id="parents-button"></div></a>
	        <a href="/fye/"><div id="students-button"></div></a>
	      </div>
	      </div>
	    <div style="clear:both"></div>
	  </div>
