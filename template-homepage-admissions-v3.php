<?php
/**
 * Template Name: Admissions Home v3
 */
?>
	...
	<div class="fourcolumn">
        ...
        <div class="col3">
            <div style="margin-left:-232px; margin-top:-45px">
                <a href="http://www.berea.edu/admissions/applying-for-admission/"><img src="https://www.berea.edu/admissions/files/2014/06/ApplyTodayButtonV4.jpg"></a>
            </div>
        </div>
	    <div class="col4">
	        <div id="nav-postit">
